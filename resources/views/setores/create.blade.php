...
<div class="py-4">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-lg font-semibold text-gray-900">Cadastrar Novo Setor</h2>
    </div>
    ...
    <form method="POST" action="{{ route('setores.store') }}">
        ...
        <div class="flex items-center justify-end gap-3 mt-4">
            ...
            <button type="submit" class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg shadow-sm transition">Salvar Setor</button>
        </div>
    </form>
</div>
@endsection
