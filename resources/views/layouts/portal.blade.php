                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-6">
                        ...
                        <nav class="flex items-center gap-1">
                            ...
                            <a href="{{ route('chat.index') }}" class="px-3 py-1.5 rounded-lg text-sm font-medium {{ request()->routeIs('chat.*') ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800' }}">Chat</a>
                        </nav>
                    </div>
