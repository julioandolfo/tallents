...
<div class="py-4 max-w-3xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-lg font-semibold text-gray-900">Novo Comunicado</h2>
    </div>
    <form method="POST" action="{{ route('comunicados.store') }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
